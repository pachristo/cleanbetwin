                ...
                <div class="card shadow-sm border-0 overflow-hidden">
                    <div class="card-body">
                        <div class="profile-avatar text-center">
                            <img src="@if (currentUser()->passport) {{ $localPath }}/users/{{ currentUser()->passport }} @else {{ $localPath }}/avatar.png @endif" class="rounded-circle shadow" width="100" height="100"
                                alt="">
                        </div>
                    ...
                    @else
                        <div class="panel-body text-center">
                            <center>
                                ...
                                @if (currentUser()->sub_count > 0)
                                    <h6 class="text-warning text-capitalize"> <strong>{{ currentUser()->sub->category }}
                        ...
                        <ul class="list-group bg-dark">
                            <li class="list-group-item"><a href="{{ route('/vip_packages') }}"><button
                                        class="btn btn-md btn-primary btn-block">Click to join Vip <i class="fa fa-futbol-o"
        ...
        <div class="col-12 col-lg-8 mt-2 nopaddingsmall">
            <div class="card shadow-sm border-0 overflow-hidden">
                <div class="card-body">
                    ...
                    <div class="col-sm-12">
                        <h4 class="text-center text-danger"> Your VIP Tips</h4>
                    </div>
