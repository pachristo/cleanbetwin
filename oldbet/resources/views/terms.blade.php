        ...
        <section class="bg-accent section-space-default">
            ...
            {{-- mobile ad --}}
                ...
                <div class="col-xl-12 col-12 ">
                    ...
                    <p>Please read the Terms carefully and if you do not accept the Terms, do not use the Website. The Terms shall apply to all Betensured.com sites and affiliate accounts (Cleanodds Blog: Cleanodds.com/blog, Cleanodds Forum: Cleanodds.com Facebook and twitter accounts respectively.</p>
