            ...
            <div class="row">
                ...
                <div class="col-sm-8 col-sm-offset-2 nopaddingsmall">
                    ...
                    <div class="col-sm-12 text-justify">
                        <p>Today’s Both To Score football/soccer predictions and the best odds for those tips of over 200 football leagues.</p>
                        <p>BTTS stands for Both Teams To Score, and is a type of market based on whether both teams score in a match or not. It is unique to football and is hugely popular among fans.</p>
                        <br><br>
                    </div>
                </div>
                <div class="col-sm-12">
