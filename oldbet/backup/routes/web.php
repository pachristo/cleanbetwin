...
// $localPath = 'https://www.cleanodds.com/images';
// $path = "https://www.cleanodds.com/administrator/images/";

View::share(compact('path', 'localPath'));


Route::get('/', 'PublicController@getHome')->name('/');

Route::get('/home', 'PublicController@getIndex')->name('/home');
...
])->name('/sureTwoOdds')->middleware(['sentinelAuth', 'superGuard']);

Route::get('/sureThreeOdds', [
    'uses' => 'PredictionController@getSureThreeOdds'
])->name('/sureThreeOdds')->middleware(['sentinelAuth', 'superGuard']);
...
])->name('/sureFiveOdds')->middleware(['sentinelAuth', 'megaGuard']);
...
])->name('/weekend_tips')->middleware(['sentinelAuth', 'superGuard']);
