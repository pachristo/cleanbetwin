...
Route::group(['middleware' => ['web']], function () {
    ...
    $path = "httpw://www.Cleanodds.com/administrator/images/";
    $path1 = "https://www.Cleanodds.com/images/users/";
    $path2 = "https://www.Cleanodds.com/administrator/images/";

    $league = League::all();

    View::share(['path' => $path, 'path1' => $path1, 'path2' => $path2, 'allleagues' => $league]);
    ...
    Route::get('/unSubscribeSms/{id?}', [
        'uses' => 'UserController@getSmsDeactivate',
        'as' => '/unSubscribeSms',
        'middleware' => 'auth',
    ]);
    ...
    Route::get('/searchSmsMember', [
        'uses' => 'UserController@getSearchSmsMember',
        'as' => '/searchSmsMember',
        'middleware' => 'auth',
    ]);
    Route::post('/searchSmsMember', [
        'uses' => 'UserController@postSearchSmsMember',
        'as' => '/searchSmsMember',
        'middleware' => 'auth',
    ]);
    ...
    Route::post('/loadmails', [
        'uses' => 'UserController@loadUserMails',
        'as' => '/loadmails',
        'middleware' => 'auth',
    ]);
    ...
    Route::get('/usersmsdetails/{uid}', [
        'uses' => 'UserController@ajaxsmsUserInfo',
        'as' => 'usersmsdetails',
        'middleware' => 'auth',
    ]);
    ...
    Route::get('/ActiveNumbers', [
        'uses' => 'BulkSmsController@getbulksms',
        'as' => '/ActiveNumbers',
        'middleware' => 'auth',
    ]);
    Route::get('/InactiveNumbers', [
        'uses' => 'BulkSmsController@getbulksmsInactive',
        'as' => '/InactiveNumbers',
        'middleware' => 'auth',
    ]);

    Route::get('/ActiveSms', [
        'uses' => 'BulkSmsController@getSendActiveSms',
        'as' => '/ActiveSms',
        'middleware' => 'auth',
    ]);
    Route::get('/InactiveSms', [
        'uses' => 'BulkSmsController@getSendInactiveSms',
        'as' => '/InactiveSms',
        'middleware' => 'auth',
    ]);
    Route::get('/GeneralSms', [
        'uses' => 'BulkSmsController@getSendGeneralSms',
        'as' => '/GeneralSms',
        'middleware' => 'auth',
    ]);

    Route::get('/ActivateSms', [
        'uses' => 'BulkSmsController@getActivateSms',
        'as' => '/ActivateSms',
        'middleware' => 'auth',
    ]);
    Route::get('/LoadSmsPlans', [
        'uses' => 'BulkSmsController@Loadsmsplans',
        'as' => '/LoadSmsPlans',
        'middleware' => 'auth',
    ]);
    Route::post('/AddSmsPlan', [
        'uses' => 'BulkSmsController@postAddPlan',
        'as' => '/AddSmsPlan',
        'middleware' => 'auth',
    ]);
    Route::post('/postAddNumber', [
        'uses' => 'BulkSmsController@postAddPhoneNumber',
        'as' => '/postAddNumber',
        'middleware' => 'auth',
    ]);
    Route::post('/updateSmsPlan', [
        'uses' => 'BulkSmsController@postUpdatePlan',
        'as' => '/updateSmsPlan',
        'middleware' => 'auth',
    ]);
    Route::post('/postActivateSms', [
        'uses' => 'BulkSmsController@postActivateSms',
        'as' => '/postActivateSms',
        'middleware' => 'auth',
    ]);

    Route::get('/allSmsmembers', [
        'uses' => 'BulkSmsController@allSmsUsers',
        'as' => '/allsmsmembers',
        'middleware' => 'auth',
    ]);
    Route::post('/send/sms', [
        'uses' => 'BulkSmsController@sendSms',
        'as' => '/send/sms',
        'middleware' => 'auth',
    ]);
    Route::get('/deletePlans/{id?}', [
        'uses' => 'BulkSmsController@getdeleteSmsPlans',
        'as' => '/deletePlans',
        'middleware' => 'auth',
    ]);
...
//
    ...
    Route::get('/plans_manager', [
        'uses' => 'GeneralController@getPlans',
        'middleware' => 'auth',
    ])->name('/plans_manager');

    Route::get('/sms', [
        'uses' => 'SMSController@getSend',
        'middleware' => 'auth',
    ])->name('/sms');
    ...
    Route::post('/sendInactive', [
        'uses' => 'BulkSmsController@sendInactiveSms',
        'middleware' => 'auth',
    ])->name('/sms.inactive');
    Route::post('/sendGeneral', [
        'uses' => 'BulkSmsController@sendGeneralSms',
        'middleware' => 'auth',
    ])->name('/general.sms');
    ...
    Route::post('/text/announcement',
        [
            'uses' => 'AnnouncementController@postTextAnnouncement',
            'middleware' => 'auth',

        ]);
    Route::post('/picture/announcement',
        [
            'uses' => 'AnnouncementController@postPictureAnnouncement',
            'middleware' => 'auth',
    ...
    Route::get('/user/testimonials', [
        'uses' => 'UserController@getTestimonials',
        'middleware' => 'auth',
    ])->name('user.testimonials');

    Route::post('/user/testimonials', [
        'uses' => 'UserController@postTestimonials',
        'middleware' => 'auth',
    ])->name('post.testimonial');
    Route::get('/delete/testimonials/{id?}', [
        'uses' => 'UserController@deleteTestimonials',
        'middleware' => 'auth',
    ])->name('testimonialDelete');
    

    Route::get('/promotion/view',[
        'uses' => 'PromotionController@getProm',
        'middleware' => 'auth',
    ])->name('promotion.view');
// post.testimonial
    Route::post('/post-promotion',[
        'uses' =>'PromotionController@postPromotion',
        'middleware'=>'auth'

    ])->name('post.promotion');

    Route::get('/update/{id?}/{status?}',[
        'uses'=>'PromotionController@update_status',
        'middleware' => 'auth'
    ])->name('promotion.update.status');
