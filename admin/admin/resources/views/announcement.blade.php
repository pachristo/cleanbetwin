...
@section('content')
    <div class="col" style="min-height: 323px;;">
        ...
        <div class="text-center">
            <button class="btn btn-primary" data-toggle="modal" data-target="#announcement" style="float: right;"><i
                    class="fa fa-plus"></i> Add Announcememt </button>
        </div>
        <br>
        <br>
        <br><br>
            ...
            <tbody>
                ...
                @foreach ($announcement as $key => $value)
                    ...
                    <tr id="pred{{ $value->id }}">
                        ...
                        @if ($value->type == 'text')
                            <td style="word-wrap: break-word; width: 633px; white-space: pre-wrap;">{!! $value->body !!}
                            </td>
                        @endif
                        ...
                        <td><a class="delete_announcement" href="{{ $value->id }}"
                                data-url="{{ url('/delete/announcement') }}"><span class="text-danger"><span
                                        class="fa fa-trash"></span> Delete</span></a></td>
        ...
        <div class="modal-dialog modal-md">
            <div class="modal-content">
                ...
                <div class="modal-body">
                        ...
                        <div id="text" class="tab-pane " style="padding-top: 20px;">

                            <form action="{{ url('/text/announcement') }}" id="text_announcement" method="post">
                                <div class="col-sm-12">
                                    <div class="form-group col-md-12">
                                        
                                        <input name="country" type="hidden" value="nigeria" />
                                    </div>
                                    ...
                                    {!! csrf_field() !!}
                                    <div class="form-group col-sm-12">
                                        <button class="btn btn-md btn-success" name="submit" id="textBtn">SUBMIT
                                            POST</button>
                                    </div>
                                </div>
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function() {
            ...
            $('#picture_announcement').submit(function(e) {
                e.preventDefault();
                $('#pictureBtn').prop('disabled', true).html(
                    "UPLOADING <i class=' fa fa-spin fa-spinner'></i>");
            ...
            $('#text_announcement').submit(function(e) {
                e.preventDefault();
                $('#textBtn').prop('disabled', true).html(
                    "Processing Data <i class=' fa fa-spin fa-spinner'></i>");
                var url = $(this).attr('action');
                var dataString = new FormData($(this)[0]);
