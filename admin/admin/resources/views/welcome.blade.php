...
<head>
    ...
    <title>CLEANODDS | ADMIN LOGIN </title>
...
<div class="">
    ...
    <center><img src="{{asset('images/logo.png')}}" class="img-responsive" style="max-height: 40px; margin-top: 100px;"> </center>
    <div id="wrapper" style="margin-top: 20px;">

        <div id="login" class="form" style="background: whitesmoke; border-radius: 8px; padding: 10px 25px;">
            <section class="login_content">
                <form action="{{route('/adminLogin')}}" id="loginForm" method="POST" data-url="{{route('/loginOperationOk')}}">
                    ...
                    <div class="separator">
                        <div class="clearfix"></div>
                        <div>
                            <p>© {{date('Y')}} | All Rights Reserved. <a href="https://CLEANODDS.com">CLEANODDS</a></p>
                        </div>
                    </div>
                </form>
            </section>
