                                    ...
                                    <tr id="pred{{$prediction->id}}">
                                        ...
                                        <td>
                                            ...
                                            @elseif($prediction->VIPCategory=='over35')
                                                Over 3.5 Goals
                                            @elseif($prediction->VIPCategory=='singleBets')
                                                Single Bets
                                            @elseif($prediction->VIPCategory=='sure5')
                                                Sure 5 Odds
                                            @elseif($prediction->VIPCategory=='matchCorner')
                                                Match Corners
                                            @elseif($prediction->VIPCategory=='correctScore')
                                               Sure 20 Odds
                                            @elseif($prediction->VIPCategory=='acca')
                                                Expert ACCA
                                            @elseif($prediction->VIPCategory=='draws')
                                                Draws
                                            @elseif($prediction->VIPCategory=='btts')
                                                BTTS/GG
