                    ...
                    <td>
                        <div class="btn-group">
                            ...
                            <ul class="dropdown-menu pull-right" role="menu" style="background: whitesmoke; -webkit-box-shadow: inset 0px 0px 10px grey;-moz-box-shadow: inset 0px 0px 10px grey;box-shadow: inset 0px 0px 10px grey;">
                                <li></li>
				                <li style="cursor: pointer;"><a class="usersmsdetails" href="{{$user->id}}" data-target="#usersmsdetails" data-toggle="modal">VIEW DETAILS</a></li>
                                ...
                                @if($user->sms_status=='1')
                                    <li style="cursor: pointer;" id="un{{$user->id}}"><a class="unsubscribesmsUser" href="{{route('/unSubscribeSms')}}" data-id="{{$user->id}}" style="color: #ef5350;" data-msg="DO YOU REALLY WANT TO UN-SUBSCRIBE THIS USER?"><span class="fa fa-times-circle-o"></span> UN-SUBSCRIBE USER</a></li>
                                @endif
                                {{-- <li class="divider"></li> --}}
                              {{--   @if($user->flag=='0')
