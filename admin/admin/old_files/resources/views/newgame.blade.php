            ...
            <div class="form-group col-md-4">
                ...
                <div class="form-group col-md-4">
                    ...
                    <select name="drawNoBet" class="form-control">
                        <option value="1 DNB">1 DNB</option>
                        <option value="2 DNB">2 DNB</option>
                        <option value="" selected>*-*-*-*-*-*-*-*-*-*</option>
                    </select>
                </div>
                ...
                {{--<div class="form-group col-md-4">--}}
                    ...
                    {{--<input type="text" name="singleBets" class="form-control" placeholder="leave blank if nothing">--}}
                {{--</div>--}}

                <div class="form-group col-md-4">
                    <label>Under 3.5 Goals</label>
                    <!-- <input type="text" name="halfTimeResults" class="form-control" placeholder="leave blank if nothing"> -->
                ...
                <div class="form-group col-md-4">
                    ...
                    <input type="text" name="bankerOfTheDay" class="form-control" placeholder="leave blank if nothing">
                </div>
