                    ...
                    <div class="menu_section">
                        <ul class="nav side-menu">
                            ...
                            <li><a><i class="fa fa-soccer-ball-o"></i> LEAGUES <span class="fa fa-chevron-down"></span></a>
                                ...
                                <li><a href="{{route('/announcement')}}"><i class="fa fa-bullhorn"></i> ANNOUCEMENTS</a></li>
                            ...
                            <li Style="background:#4e1919;"><a href="{{ route('/plans_manager') }}"><i class="fa fa fa-credit-card-alt"></i> PLAN MANAGER <span class="fa fa-"></span></a>
