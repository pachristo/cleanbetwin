    ...
    public function planUpdater(Request $request)
    {
        ...
        $planBenefits = trim($request['planBenefits']);
                Subscription::where('id', $id)
                    ->update(['planName' => $plan, 'accessTime' => $accessTime, 'nairaPrice'=>$nairaPrice, 'keshPrice'=>$keshPrice, 'dollarPrice'=>$dollarPrice ,'cedPrice'=>$cedPrice, 'tzsPrice'=>$tzsPrice, 'zmwPrice'=>$zmwPrice,'ugxPrice'=>$ugxPrice,'zarPrice'=>$zarPrice,'planBenefits'=>$planBenefits]);
