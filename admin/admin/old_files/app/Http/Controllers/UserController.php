...
class UserController extends Controller
{
    ...
    public function subscribedUsers()
    {
        ...
        $silver = User::where('subscription_status', '1')
            ...
            {
                $query->where('subscription_id', 1)->orWhere('subscription_id', 2)->orWhere('subscription_id', 3)->orWhere('subscription_id', 4);
            })
        ...
        $gold = User::where('subscription_status', '1')
            ->where(function ($query)
            {
                $query->where('subscription_id', 5)->orWhere('subscription_id', 6)->orWhere('subscription_id', 7)->orWhere('subscription_id', 8);
            })
            ->orderBy('date_subscribed', 'DESC')->paginate(1000);
        ...
        return view('/activeSubscribers', compact('silver', 'gold', 'investment'));
    }
    ...
    public function expiredUsers()
    {
        ...
        return view('/expiredSubscribers', compact('silver', 'gold', 'investment'));
    }
