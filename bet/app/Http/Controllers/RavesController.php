...
class RavesController extends Controller
{
    public function getFinish($id=null, $txRef=null, Transaction $transaction)
    {
        ...
        $data = array('txref' => $txRef,
            'SECKEY' => 'FLWSECK-8798d9c7f193c0844b8b423f2ebc1e79-X' //secret key from pay button generated on rave dashboard
            //  'SECKEY' => 'FLWSECK_TEST-f918939659bd03f568fa7db85f2e6ae9-X' //secret key from pay button generated on rave dashboard
        );
