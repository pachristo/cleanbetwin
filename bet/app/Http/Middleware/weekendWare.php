...
class weekendWare
{
    ...
    public function handle($request, Closure $next)
    {
        ...
        elseif (currentUser()->sub->id=='1' || currentUser()->sub->id=='2' || currentUser()->sub->id=='12' ||currentUser()->sub->id=='3' || currentUser()->sub->id=='4' || currentUser()->sub->id=='5' || currentUser()->sub->id=='6'|| currentUser()->sub->id=='13' || currentUser()->sub->id=='14') return $next($request);
        else
        {
