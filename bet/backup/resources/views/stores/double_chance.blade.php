...
<head>
    <title>Double Chance | Cleanodds.com</title>
    ...
    <meta name="viewport" content="width=device-width, initial-scale=1, maximum-scale=1.0, user-scalable=0">
        <meta name="keywords" content="double chance predictions, free football prediction" />
        <meta name="description"content="The best predictions on double chance for football matches of all the championships of the world. Champions League, Europa League, Premier League, etc."/>
...
<!-- The above 3 meta tags *must* come first in the head; any other head content must come *after* these tags -->
    ...
    <meta property="og:title" content="Double Chance | Cleanodds.com" />
    <meta property="og:description" content="The best predictions on double chance for football matches of all the championships of the world. Champions League, Europa League, Premier League, etc." />
            ...
            <div class="row">
                ...
                <div class="col-sm-8 col-sm-offset-2 nopaddingsmall">
                    ...
                    <div class="col-sm-12 text-justify">
                        <p>This page shows all 1X, 12, X2 (Double Chance) football predictions from our tipsters/experts, all our soccer predictions contain the country or continent, the league and bet tips. You can also check out other betting markets by clicking on the bet market below the predictions.</p>
                        <br><br>
                    </div>
                </div>
                <div class="col-sm-12">
