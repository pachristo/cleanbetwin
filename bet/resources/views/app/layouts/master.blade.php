  ...
  <div class="wrapper">
    <!--start top header-->
      ...
      Investemnt
        ...
        @elseif(currentUser()->sub->id=='15')

        <li >
          <a     href="{{
              route('/todays_vip_tips') }}"><i class="fa fa-arrow-circle-right"></i>
    Today's VIP Tips

          </a>
      </li>
      @elseif(currentUser()->sub->id=='16')

      <li >
        <a     href="{{
            route('/todays_vvip_tips') }}"><i class="fa fa-arrow-circle-right"></i>
  Today's VVIP Tips

        </a>
    </li>
    @elseif(currentUser()->sub->id=='17')

    <li >
      <a     href="{{
          route('/todays_ordinary_vip_tips') }}"><i class="fa fa-arrow-circle-right"></i>
Today's Ordinary VIP Tips

      </a>
  </li>
  @elseif(currentUser()->sub->id=='18')

  <li >
    <a     href="{{
        route('/fridays_vip_tips') }}"><i class="fa fa-arrow-circle-right"></i>
Friday's  VIP Tips

    </a>
</li>

@elseif(currentUser()->sub->id=='19')

<li >
  <a     href="{{
      route('/saturdays_vip_tips') }}"><i class="fa fa-arrow-circle-right"></i>
Saturday's  VIP Tips

  </a>
</li>

@elseif(currentUser()->sub->id=='20')

<li >
  <a     href="{{
      route('/sundays_vip_tips') }}"><i class="fa fa-arrow-circle-right"></i>
Sunday's  VIP Tips
