        ...
        <div class="container">
            ...
            <div class="col-lg-12 nopaddingsmall ">
                ...
                <script>
                    ...
                    //test  FLWPUBK_TEST-54dafcfc4d1439dbeddafa1d68a4f63b-X
                    const API_publicKey = "FLWPUBK-86ab8135529e15db90bd4d3c73fe8126-X";
                //  const API_publicKey = "FLWPUBK_TEST-54dafcfc4d1439dbeddafa1d68a4f63b-X";
                    ...
                    function payWithRave() {
                        swal({
  title: "Opps",
  text: "Please kindly contact the admin via surecleanodds@gmail.com for payment ",
  icon: "warning",
  buttons: true,
  dangerMode: true,
});
